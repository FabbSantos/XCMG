    ...
    return (
        <div class="bg-[#004C96]">
            <div class="max-w-[90vw] mx-auto flex flex-col justify-center items-center py-[3em] gap-[1em]">
                ...
                <div class="flex flex-col md:flex-row  items-start justify-around w-full max-w-[60vw] mt-10">
                    ...
                    <img src={iso} alt="International Organization for Standardization" width="130px" height="auto" loading="lazy" />
                    <img src={great} alt="Certificado Great Place to Work" width="80px" height="auto" loading="lazy" />
                </div>
