...
export default component$(() => {
    return (
        <div id="consorcio" class="flex flex-col md:flex-row justify-center md:justify-around align-center bg-bg-3m bg-cover py-[2em] sm:bg-bg-3">
            ...
            <div class="flex flex-col justify-start items-center gap-2 text-white basis-[23%] bg-[#004C96] rounded-xl pt-5">
                <h2 class="text-xl min-h-[2.5em] text-center font-extrabold mx-2">Planos diferenciados</h2>
            ...
            <div class="flex flex-col justify-start items-center gap-2 text-white basis-[23%] bg-[#004C96] rounded-xl pt-5">
                ...
                <ul class="max-w-[80%] text-center p-0">
                    <li>Assembléias transmitidas ao vivo, via internet</li>
                </ul>
            </div>
        </div>
    ) 
